...
class TestMarketingAutomationFlow(common.TransactionCase):

    def test_00_marketing_automation_flow(self):

        Workitem = self.env['marketing.automation.workitem']

        # In order to test process of compaign, I start compaign.
        partner_channel = self.env.ref('marketing_automation.marketing_automation_openerppartnerchannel')
        ...
        segment0 = self.env.ref('marketing_automation.marketing_automation_segment0')
        ...
        activity0_id = self.ref('marketing_automation.marketing_automation_activity_0')
        workitems = Workitem.search([
            ('segment_id', '=', segment0.id),
            ('campaign_id', '=', partner_channel.id),
        ...
        activity1_id = self.ref('marketing_automation.marketing_automation_activity_1')
        workitems = Workitem.search([
            ('segment_id', '=', segment0.id),
            ('campaign_id', '=', partner_channel.id),
        ...
        activity2_id = self.ref('marketing_automation.marketing_automation_activity_2')
        workitems = Workitem.search([
            ('segment_id', '=', segment0.id),
            ('campaign_id', '=', partner_channel.id),
